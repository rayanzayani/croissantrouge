...
<!-- le traitement des données -->
	...
	<table class="table">
		...
		<tr>
			...
			<td><?php echo $value1->dateEv; ?></td>
			<td><?php echo $value1->localisation; ?></td>
			<td><?php echo $value1->dateAj; ?></td>
			<td><center><a href="<?php echo static::$conf['base_url']; ?>evenement/edit/<?php echo $value1->id; ?>" title="Modifier"><img src="<?php echo static::$conf['base_url']; ?>/skin/admin/public/edit.png"/></a><center></td>
			<td><center><a href="<?php echo static::$conf['base_url']; ?>evenement/del/<?php echo $value1->id; ?>" title="Supprimer"><img src="<?php echo static::$conf['base_url']; ?>/skin/admin/public/basket.png"/></a><center></td>
		</tr>
		<?php } ?>
		</tbody>
	</table>
