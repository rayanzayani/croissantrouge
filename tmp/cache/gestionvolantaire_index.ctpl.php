								...
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											<li> <a href="<?php echo static::$conf['base_url']; ?>#"><i class="fa fa-cog"></i>Settings</a> </li>
											<li> <a href="<?php echo static::$conf['base_url']; ?>login/logout"><i class="fa fa-sign-out"></i>Logout</a> </li>
										</ul>
									</li>
								</ul>
							</div>
    ...
    <!--<div class="sidebar-menu">		  
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li>
					<a href="<?php echo static::$conf['base_url']; ?>#"><span>Gestion des volantaires</span></a>
		        </li><br/>
				<li>
					<a href="<?php echo static::$conf['base_url']; ?>#"><span>Gestion des biens</span></a>
		        </li><br/>
				<li>
					<a href="<?php echo static::$conf['base_url']; ?>#"><span>Gestion des événements</span></a>
		        </li><br/>
				<li>
					<a href="<?php echo static::$conf['base_url']; ?>#"><span>Gestion des catégories</span></a>
		        </li><br/>
				<li>
					<a href="<?php echo static::$conf['base_url']; ?>#"><span>Gestion des donneurs</span></a>
		        </li><br/>
				<li>
					<a href="<?php echo static::$conf['base_url']; ?>#"><span>Statistiques</span></a>
		        </li><br/>
				<li>
